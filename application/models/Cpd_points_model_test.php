...
class Cpd_points_model_test extends CI_Model
{
...
foreach($records as $record ){
   ...
   $action = '<a href="'.$base_url.'cpd_points/edit_view/'.$id.'"data-original-title="Edit"><i class="fa fa-pencil text-inverse m-r-10"></i></a> <a href="'.$base_url.'cpd_points/delete/'.$id.'" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('.$test1.');"><i class="fa fa-close text-danger"></i></a> <div class="col-sm-6 col-md-4 col-lg-6"><a href="'.$base_url.'cpd_points/addToActive/'.$id.'" data-toggle="tooltip" data-original-title="At To Active" onclick="return confirm('.$test.');"><i class="fa fa-check-circle"></i></a></div>';
   $PDFaction = '<div class="col-sm-6 col-md-4 col-lg-3"><a href="'.$base_url.'cpd_points_test/get_ajax_PDF/'.$id.'" class="generate-PDF" data-id="'.$id.'" data-original-title="Edit"><i class="fa fa-file-pdf-o"></i></a></div>'; 
   $data[] = array( 
    "ProductCode"=>$record->ProductCode,
    "Activity"=>$record->Activity,
    "StartDate"=>$record->StartDate,
