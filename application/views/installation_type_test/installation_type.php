...
$attributes_installationType = array('class' => 'Installation_type', 'data-toggle'=>'validator', 'id' => 'Installation_type1', 'method' => 'post');
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="white-box">           
        <?php echo form_open_multipart('installation_type_test/index', $attributes_installationType); ?>    
        ...
        <div class="form-group">          
          <button type="submit" name="<?php echo $button; ?>" class="btn btn-rounded btn-sm btn-primary"><?php echo $heading; ?> Installtion Type</button>
        </div>
      </form>
