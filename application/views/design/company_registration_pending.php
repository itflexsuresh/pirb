...
<div class="row page-titles">
	<div class="col-md-5 align-self-center">
		<h4 class="text-themecolor">Pending Companies Profiles</h4>
	</div>
	<div class="col-md-7 align-self-center text-right">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="j<?php echo base_url().'admin/dashboard'; ?>">Home</a></li>
				<li class="breadcrumb-item active">Pending Companies Profiles</li>
			</ol>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">Pending Companies Profiles</h4>
				<form class="mt-4 form" action="" method="post">
					...
					<div class="tab-content tabcontent-border add_top_value">
						...
						<div class="tab-pane active p-20" id="tab1" role="tabpanel">
							<div class="row add_background_color">
								<h4 class="card-title add_left_value">Application Status</h4>
								<div class="col-md-5">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="custom-control custom-radio">
								                        <input type="radio" id="approve" name="status" class="custom-control-input">
												...
												<div class="col-md-5">
													<div class="custom-control custom-radio">
								                        <input type="radio" id="reject" name="status" class="custom-control-input">
									...
									<div class="row mt_40">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="custom-control custom-checkbox">
							                            ...
							                            <label class="custom-control-label" for="cannot_verifiy">Cannot Verifiy</label>
							                        </div>
												</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="If Other specify" name="">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group mb_0">
												...
												<textarea class="form-control add_height" id="" name="" value=""></textarea>
											</div>
										</div>
							...
							<h4 class="card-title add_top_value">Company Registration Details</h4>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
