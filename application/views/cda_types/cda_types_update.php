 ...
 <div class="row">
  <div class="col-sm-12">
    <div class="white-box">
      ...
      <!-- <form data-toggle="validator"> -->
       ...
       ?>
       <?php
       echo form_open_multipart('cda_types/get_udpate/'.$CPD_Id.'', $attributes_installationType);
       ?>
       <div class="row">
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="number" name="cpdpoints" value="<?php echo $records[0]->Points; ?>" class="form-control" autocomplete="off" placeholder="Enter an CDA Points" autocomplete="off" required>
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="end_date" name="end_date" value="<?php echo $end_DD; ?>" placeholder="Enter an CDA End Date" class="form-control" autocomplete="off" required>
            <div class="help-block with-errors"></div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="product_code" value="<?php echo $records[0]->ProductCode; ?>"  class="form-control" autocomplete="off" placeholder="Enter an Product Code" autocomplete="off" required>
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" name="CPDstreams">
              <option value="Developmental Activities"<?php if($records[0]->CPDStream=='Developmental Activities'){ echo 'selected="selected"'; } ?>>Developmental</option>
              <option value="Work-based Activities"<?php if($records[0]->CPDStream=='Work-based Activities'){ echo 'selected="selected"'; } ?>>Work-based</option>
              <option value="Individual Activities"<?php if($records[0]->CPDStream=='Individual Activities'){ echo 'selected="selected"'; } ?>>Individual</option>
            </select>
          </div>
          <div class="help-block with-errors"></div>
        </div>
     ...
     <div class="form-group">
      <button type="submit" name="ContentPlaceHolder1btn_Add_location_types" class="btn btn-rounded btn-sm btn-primary">Update CDA Types</button>
      <button type="button" class="btn  btn-rounded btn-sm btn-inverse waves-effect waves-light" onclick="window.location.href = '<?php echo base_url()."cda_types/view/";?>';">Cancel</button>      
    </div>
  </form>
  ...
  <div class="col-lg-8 col-sm-13 col-xs-12">
    <button type="button" name="ContentPlaceHolder1btn_addmanage" class="btn pull-right m-l-25 btn-primary btn-rounded" onclick="window.location.href = '<?php echo base_url()."cda_types/view/";?>';">Go Baack</button>
  </div>
</div>
