...
<script>
 ...
 <!-- Calendar JavaScript -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/bootstrap-rtl-master/dist/js/bootstrap-rtl.min.js"></script>
    ...
    $(document).ready(function($) {
	 ...
	 <!-- Chart Files -->
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/flot/jquery.flot.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/flot/jquery.flot.min.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/flot/jquery.flot.pie.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/flot/jquery.flot.categories.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/flot/jquery.flot.resize.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/liquid-meter/liquid.meter.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/snap.svg/snap.svg.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/snap.svg/snap.svg.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>optimum/liquid-meter/liquid.meter.js"></script>
	
		<!-- Examples -->
		<!-- <script type="text/javascript" src="<?php // echo base_url();?>assets/javascripts/dashboard/custom_dashboard.js"></script>
		<script type="text/javascript" src="<?php // echo base_url();?>assets/javascripts/forms/custom_validation.js"></script>
        <script type="text/javascript" src="<?php // echo base_url();?>assets/javascripts/tables/examples.datatables.default.js"></script>
		<script type="text/javascript" src="<?php // echo base_url();?>assets/javascripts/tables/examples.datatables.tabletools.js"></script> -->
...
<script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/tinymce/tinymce.min.js"></script>
    <script>
    $(document).ready(function() {
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
	<?php if (($this->session->flashdata('flash_message')) != ""): ?>
	<script type="text/javascript">
    $(document).ready(function() {
        $.toast({
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/switchery/dist/switchery.min.js"></script>
<script>
    ...
    <!--Style Switcher -->
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/Magnific-Popup-master/dist/jquery.magnific-popup.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/Magnific-Popup-master/dist/jquery.magnific-popup-init.js"></script>
...
<script>
    ...
    if (document.getElementById('yesCheck').checked) {
	 ...
	 <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/dropify/dist/js/dropify.min.js"></script>
    <script>
    $(document).ready(function() {
        // Basic
        $('.dropify').dropify();
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/jquery-wizard-master/dist/jquery-wizard.min.js"></script>
 <!-- FormValidation -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/jquery-wizard-master/libs/formvalidation/formValidation.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/jquery-wizard-master/libs/formvalidation/bootstrap.min.js"></script>
	
	 <!-- Typehead Plugin JavaScript -->
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/typeahead.js-master/dist/typeahead.bundle.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>optimum/plugins/bower_components/typeahead.js-master/dist/typeahead-init.js"></script>
    ...
    <!--FooTable init-->
    <script src="<?php echo base_url(); ?>optimum/js/footable-init.js"></script>
...
<script src="http://diyesh.com/auditit_new/auditit/assets/js/libraries/dist/jquery-qrcode.js"></script>
</body>
