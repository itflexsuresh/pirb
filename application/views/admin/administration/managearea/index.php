	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php if($checkpermission){ ?>
					<form class="mt-4 form" action="" method="post">
						...
						<div class="form-group col-6 new-city" style="display:none;">
							...
							<input type="text" class="form-control" id="city1" name="city1" value="<?php echo $suburb; ?>" placeholder="Please enter the city">
						</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped fullwidth citytable">
						<thead>
							<tr>
								<th>Province</th>
								<th>City</th>
