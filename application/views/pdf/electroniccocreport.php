  ...
  <body style=" font-family:Helvetica; -webkit-print-color-adjust: exact; margin:0;  font-family: arial; width:auto;">
      <div id="wrapper">
          <div class="certificate-block">
              <div class="container" style=" font-family:Helvetica; width:auto; margin:0 auto; padding:16px 25px 25px 25px; border: 4px solid #00aeef; border-radius: 50px; margin-bottom: 10px;">
                  <div class="uper-block">
                      ...
                      <div class="rt-side" style=" font-family:Helvetica; float: right;width: 50%;padding: 20px 0 0 15px;margin-top: 50px; box-sizing: border-box;">
                          <div class="box" style=" font-family:Helvetica; height: 40px; padding:7px 4px 3px 6px; margin: 0 0 4px; background: #d1d3d4;">
                              <h4 style=" font-family:Helvetica; font-size: 23px;font-weight: 400;color: #000;padding:10px;float: left; margin:0;">Certificate No:</h4><span style=" font-family:Helvetica; background: #fff;padding:12px 0;width: 70%;display: inline-block;height: 14px;float: right; padding-left: 10px;">'.$cocid.'</span>
                  ...
                  <div class="address-block" style=" font-family:Helvetica; border: 1px solid #aab294; margin:12px 0">
                      <h2 style=" font-family:Helvetica; text-align: center;background: #c9db82;padding: 10;border-bottom: 1px solid #aab294;font-size: 18px;line-height: 18px;color: #000; margin:0px;">Physical Address Details of Installation:</h2>
                      ...
                      <div class="block" style=" font-family:Helvetica;  border-bottom: 1px solid #aab294; width:60%; box-sizing:border-box; float:right; border-left:1px #424242 solid;">
                          <h5 style=" font-family:Helvetica; font-size:20px; line-height: 17px; font-weight: 300; color: #000; padding: 8px 7px; margin:0;">Name of Complex/Flat and Unit Number (if applicable): '.$address.'</h5>
                      </div>
                      <div style=" font-family:Helvetica; clear:both;"></div>
                  ...
                  <div class="up_block" style=" font-family:Helvetica; margin: 6px 0 0; border: 1px solid #adabad;">
                      <div class="top" style=" font-family:Helvetica; border-bottom: 1px solid #adabad;">
                         ...
                         <div class="block_sec" style=" font-family:Helvetica; width:10%; float: left; border-right: 1px solid #adabad; text-align: center; padding:19px 0;">
                             <h4 style=" font-family:Helvetica; font-size:18px; margin:0;">Code</h4>
                         </div>
                         <div class="block_sec" style=" font-family:Helvetica; width:10%;float: left;text-align: center;padding: 19px 0;">
...
if($agreementid=='1'){
  ...
  ';
          ...
          echo' </div>
                  ...
                  <div class="white_box" style=" font-family:Helvetica; border:1px solid #adafb1; margin:0px 0 0; border-top: none; font-size:16px;">
  ...
  <div class="certificate-block" style="margin-top:0px; ">
    <div class="container" style=" font-family:Helvetica; width:1327px; margin: 380px auto 100px auto; padding:10px 15px 15px 15px; border: 4px solid #00aeef; background: #fff; border-radius: 20px; ">
        ...
        <div class="lt-block" style=" font-family:Helvetica; float: left; width:50%;">
            ...
            <p style=" font-family:Helvetica; font-size: 14px; line-height: 17px; padding: 0; margin: 2px 0; color: #000; font-weight: 400;text-align: justify;"> A  Plumbing  COC  is  a  means  by  which  the  Plumbing  Industry  Registration  Board  (PIRB) 
              ...
              <h3 style=" font-family:Helvetica; margin:10px 0 10px 0; font-size:16px; line-height: 17px; color: #000; text-transform: uppercase; ">JOBS wHICH REqUIRE A COC</h3>
              ...
              <ul style=" font-family:Helvetica; font-size: 14px; line-height: 30px;  color: #000; font-weight: 400;">
                    <li style=" font-family:Helvetica; line-height: 15px; margin-bottom: 10px; padding-bottom:0px;">Where the total value of the work, including materials, labour and VAT, is more than the prescribe value as defined by the PIRB (material costs must be included, regardless of whether the materials were supplied by another person) a certificate must be issued for the following:</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">When an Installation, Replacement and/or Repair of Hot Water Systems and/ or Components is carried out</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px; float: right; width:90%; ">When an Installation, Replacement and/or Repair of Cold Water Systems and/ or Components is carried out</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">Installation, Replacement and/or Repair of Sanitary-ware and Sanitary-fittings is carried out</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">Installation, Replacement and/or Repair of a Solar Water Heating System</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%;">Installation, Replacement and/or Repair of a Below-ground Drainage System</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">Installation, Replacement and/or Repair of an Above-ground Drainage System</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">Installation, Replacement and/or Repair of an Above-ground Drainage System</li><br>
                          <li style=" font-family:Helvetica; margin-bottom: 5px; line-height: 15px;float: right; width:90%; ">Installation, Replacement and/or Repair of a Heat Pump Water Heating System</li><br>
                          <div style=" font-family:Helvetica; clear:both;"></div>
