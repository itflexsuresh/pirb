...
<html>
  ...
  <body style=" font-family:Helvetica; -webkit-print-color-adjust: exact; margin:0;  font-family: arial; width:100%; ">
      <div id="wrapper">
          <div class="certificate-block">
              <div class="container" style=" font-family:Helvetica; width:1300px; margin:0 auto; padding:16px 25px 25px 25px; border: 4px solid #00aeef; border-radius: 50px;">
                  <div class="uper-block">
                      ...
                      <div class="logo-block" style=" font-family:Helvetica; width:48%; float: left; ">                         
                          <img style=" font-family:Helvetica; margin-top: 50px; width: 100%; height: auto;" src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/logo-img.png" />
                      </div>
                      <div class="rt-side" style=" font-family:Helvetica; float: right;width: 50%;padding: 20px 0 0 15px;margin-top: 50px; box-sizing: border-box;">
                          <div class="box" style=" font-family:Helvetica; height: 40px; padding:7px 4px 3px 6px; margin: 0 0 4px; background: #d1d3d4;">
                              <h4 style=" font-family:Helvetica; font-size: 23px;font-weight: 400;color: #000;padding:10px;float: left; margin:0;">Certificate N:</h4><span style=" font-family:Helvetica; background: #fff;padding:12px 0;width: 70%;display: inline-block;height: 14px;float: right;">'.$cocid.'</span>
                              <div style=" font-family:Helvetica; clear:both;"></div>
                          </div>
                          <div class="box" style=" font-family:Helvetica; text-align: center;padding:10px;margin: 0 0 4px;background: #f3cfc1;;">
                              <p style=" font-family:Helvetica; font-size:14px;line-height:19px;font-weight: 500;color: #000;padding: 0;margin:0;">ONLY PIRB REGISTERED LICENSED PLUMBERS ARE AUTHORISED TO ISSUE THIS PLUMBING CERTIFICATE OF COMPLIANCE</p>
                          </div>
                          <div class="box" style=" font-family:Helvetica; background: #d2232a;font-size: 14px;color: #fff;text-align: center;padding:12px;">
                              <p style=" font-family:Helvetica; font-size: 14px;font-weight: 500;padding:0; margin: 0;">TO VERIFY AND AUTHENTICATE THIS CERTIFICATE OF COMPLIANCE VISIT PIRB.CO.ZA AND CLICK ON VERIFY/AUTHENTICATE LINK</p>
                          </div>
                      </div>
                      <div style=" font-family:Helvetica; clear:both;"></div>
                  </div>
                  <div class="down-block" style=" font-family:Helvetica; padding-bottom: 4px; margin-top: 70px;">
                      <div class="lt-side" style=" font-family:Helvetica; float: left; width:50%;">
                          <label style=" font-family:Helvetica; font-size: 18px; line-height: 22px; font-weight: 400; color: #000; padding: 0; margin: 0px 30px; float: left;">Plumbing Work <br>Completion Date:</labeel> <span style=" font-family:Helvetica; width:60%;height: 40px;border: 1px solid #bbbcbe;display: inline-block;padding: 0;margin: 0;float: right;"> '.$completiondate.'</span>
                      </div>
                      <div class="rt-side" style=" font-family:Helvetica; float: right; width:47%; clear: both;">
                          <label style=" font-family:Helvetica; font-size: 18px;line-height: 23px;font-weight: 400;color: #000;padding: 0;margin:11px 0 0;float: left;">INSURANCE CLAIM/ORDER NO. (If relevant)</label><span style=" font-family:Helvetica; width: 40%;height: 25px;border: 1px solid #bbbcbe;display: inline-block;padding: 0;margin:11px 0 0;float: right;"> '.$cl_order_no.'</span>
                      </div>
                      <div style=" font-family:Helvetica; clear:both;"></div>
                  </div>
                  <div style=" font-family:Helvetica; clear:both;"></div>
                  <div class="address-block" style=" font-family:Helvetica; border: 1px solid #aab294; margin:12px">
                      <h2 style=" font-family:Helvetica; text-align: center;background: #c9db82;padding: 10;border-bottom: 1px solid #aab294;font-size: 18px;line-height: 18px;color: #000; margin:10px;">Physical Address Details of Installation:</h2>
                      <div class="block" style=" font-family:Helvetica;  border-bottom: 1px solid #aab294; width:40%; float:left">
                          <h5 style=" font-family:Helvetica; font-size:20px; line-height:17px; font-weight: 300; color: #000; padding: 8px 7px; margin:0;">Owners name: '.$name.'</h5>
                      </div>
                      <div class="block" style=" font-family:Helvetica;  border-bottom: 1px solid #aab294; width:60%; box-sizing:border-box; float:right; border-left:1px #424242 solid;">
                          <h5 style=" font-family:Helvetica; font-size:20px; line-height: 17px; font-weight: 300; color: #000; padding: 8px 7px; margin:0;">Name of complex/flat (if applicable): '.$address.'</h5>
                      </div>
                      <div style=" font-family:Helvetica; clear:both;"></div>
                      ...
                      <div class="block" style=" font-family:Helvetica;  border-bottom: 1px solid #aab294;">
                          <div class="lt-left" style=" font-family:Helvetica; width: 55%; border-right: 1px solid #adabad; float: left;">
                  ...
                  <div class="up_block" style=" font-family:Helvetica; margin: 6px 0 0; border: 1px solid #adabad;">
                      <div class="top" style=" font-family:Helvetica; border-bottom: 1px solid #adabad;">
                         <div class="block_sec" style=" font-family:Helvetica; width:79%; float: left; border-right: 1px solid #adabad; background: #d1e28d; text-align: center; padding:10px 0;">
                             <h4 style=" font-family:Helvetica; font-size:18px; line-height:18px; margin:0;">Type of Installation Carried Out by '.$designation2[$userdata['designation']].'</h4>
                              <p style=" font-family:Helvetica; padding: 0; margin: 0; font-size:18px;">(Clearly tick the appropriate Installation Category Code and complete the installation details below)</p>
                         </div>
                         <div class="block_sec" style=" font-family:Helvetica; width:10%; float: left; border-right: 1px solid #adabad; text-align: center; padding:9px 0;">
                             <h4 style=" font-family:Helvetica; font-size:18px; margin:0;">Code</h4>
                         </div>
                         <div class="block_sec" style=" font-family:Helvetica; width:10%;float: left;text-align: center;padding: 9px 0;">
                             <h4 style=" font-family:Helvetica; font-size:18px; margin:0;">Tick</h4>
                         </div>
                         <div style=" font-family:Helvetica; clear:both;"></div>
                      </div>'; 
          ...
          echo' </div>
                  <div class="up_block" style=" font-family:Helvetica; margin: 6px 0 0; border: 1px solid #adabad;">
                      <div class="top" style=" font-family:Helvetica; border-bottom: 1px solid #adabad;">
                         <div class="block_sec" style=" font-family:Helvetica; width:79%; float: left; border-right: 1px solid #adabad; background: #d1e28d; text-align: center; padding:10px 0;">
                             <h4 style=" font-family:Helvetica; font-size:16px; line-height:18px; margin:0;">Specialisations: To be Carried Out by Licensed Plumber Only Registered to do the Specialised Work </h4>
                              <p style=" font-family:Helvetica; padding: 0; margin: 0; font-size:18px;">(To verify and authenticate Licensed Plumbers specialisations visit pirb.co.z)</p>
                         </div>
                         <div class="block_sec" style=" font-family:Helvetica; width:10%; float: left; border-right: 1px solid #adabad; text-align: center; padding:9px 0;">
                             <h4 style=" font-family:Helvetica; font-size:18px; margin:0;">Code</h4>
                         </div>
...
if($agreementid=='1'){
	...
	';
          ...
          echo' </div>
                  <div class="block" style=" font-family:Helvetica; text-align: center;">
                      ...
                      <p style=" font-family:Helvetica; padding: 5px 0; margin: 0; font-size: 16px; line-height: 12px; color: #000; font-weight: 400; font-style: italic;">See explanations of the above on the reverse of this certificate</p>
                  </div>
                  <div class="installetion" id="preexisting_table" style=" font-family:Helvetica; border:1px solid #a7a9ab;">
                      <div class="box" style=" font-family:Helvetica; background: #d1e28d; padding: 10px 5px; border-bottom:1px solid #a7a9ab;">
                          <h4 style=" font-family:Helvetica; font-size: 19px; line-height:18px; font-weight: 600; margin:0;">Installation Details <span style=" font-family:Helvetica; font-size: 18px;line-height: 10px;font-weight: 400;">(Details of the work undertaken or scope of work for which the COC is being issued for)</span></h4>
                      </div>
                      <div class="box" style=" font-family:Helvetica; background: #fff; padding: 10px 5px; border-bottom:1px solid #e7e8e9;">
                          <h6 style=" font-family:Helvetica; font-size:14px; margin:0;">'.$result['cl_installation_detail'].'</h6>
                      </div>
                      <div class="box" style=" font-family:Helvetica; background: #fff; padding: 10px 5px; border-bottom:1px solid #e7e8e9;">
                          <h6 style=" font-family:Helvetica; font-size:14px; margin:0;"> </h6>
                      </div>
                      <div class="box" style=" font-family:Helvetica; background: #fff; padding: 10px 5px; border-bottom:1px solid #e7e8e9;">
                          <h6 style=" font-family:Helvetica; font-size:14px; margin:0;"> </h6>
                      </div>
                  ...
                  <div class="installetion" style=" font-family:Helvetica; border:1px solid #a7a9ab; margin:5px 0 0">
                      <div class="box" style=" font-family:Helvetica; background: #d1e28d; padding:10px 5px; border-bottom:1px solid #a7a9ab; text-align: center;">
                          <h4 style=" font-family:Helvetica; font-size:19px; line-height:14px; font-weight: 600; margin:0;">Pre-Existing Non Compliance* Conditions 
                          <span style=" font-family:Helvetica; font-size:18px; line-height:17px; font-weight: 400;">(Details of any non-compliance of the pre-existing plumbing installation on which work was done  that needs to be brought to the attention of owner/user)</span></h4>
                      </div>
                       <div class="box" style=" font-family:Helvetica; background: #fff; padding: 10px 5px; border-bottom:1px solid #e7e8e9;">
                          <h6 style=" font-family:Helvetica; font-size:15px; margin:0;"></h6>
                      </div>
                       <div class="box" style=" font-family:Helvetica; background: #fff; padding: 10px 5px; border-bottom:1px solid #e7e8e9;">
                          <h6 style=" font-family:Helvetica; font-size:14px; margin:0;"> </h6>
                      </div>
                  ...
                  <div class="white_box" style=" font-family:Helvetica; border:1px solid #adafb1; margin:5px 0 0; font-size:16px;">
                      ...
                      <p class="brdr-dshed" style="line-height: 0px; border-bottom:1px dashed #adafb1;width: 60%; float: left; display: inline-block;padding-top: 10px;height: 0.5px">Digitally Signed by '.$userdata['name'].' '.$userdata['surname'].', on '.$logdate.' at '.$logtime.'</p>
                      </div>
                  ...
                  <div class="notoice" style=" font-family:Helvetica; border:1px solid #adafb1; margin: 6px 0 0 0; background: #f3cfc1;">
                      <div class="text" style=" font-family:Helvetica; padding:10px; background: #d2232a; text-align: center; color: #fff;">
                          <p style=" font-family:Helvetica; padding: 0; margin: 0; font-size:18px; line-height:14px; font-weight:600;">IMPORTANCE NOTICE</p>
                      </div>
  
                      <div class="text" style=" font-family:Helvetica; padding:3px 10px 0 5px;">
                          <span style=" font-family:Helvetica; padding: 0 0 0 0; float: left; width:3%;"><img src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/round.png" style=" font-family:Helvetica; margin:10px;" /></span>
                      ...
                      <div class="text" style=" font-family:Helvetica; padding:3px 10px 0 5px;">
                          <span style=" font-family:Helvetica; float: left; width: 3%; padding: 0 0 0 0;"><img src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/round.png" style=" font-family:Helvetica; margin:10px;"/></span>
                      ...
                      <div class="text" style=" font-family:Helvetica; padding:3px 10px 0 5px;">
                          <span style=" font-family:Helvetica; float: left; width: 3%; padding: 0 0 0 0;"><img src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/round.png" style=" font-family:Helvetica; margin:22px 6px;" /></span>
                      ...
                      <div class="text" style=" font-family:Helvetica; padding:3px 10px 0 5px;">
                          <span style=" font-family:Helvetica; float: left; width: 3%; padding: 0 0 0 0;"><img src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/round.png"  style=" font-family:Helvetica; float:left;margin:10px;" /></span>
                  ...
                  <div class="owners" style=" font-family:Helvetica; margin: 2px 0 0;">
                      <img style=" font-family:Helvetica; width: 100%; height: auto;" src="'.$_SERVER['DOCUMENT_ROOT'].'/auditit_new/pirb/assets/images/owners.png" />
                  </div>
              </div>
          </div>
      </div>
  ...
  <div id="wrapper">
  <div class="certificate-block">
    <div class="container" style=" font-family:Helvetica; width:1327px; margin: 280px auto 100px auto; padding:10px 15px 15px 15px; border: 4px solid #00aeef; background: #fff; border-radius: 20px; ">
        ...
        <div class="lt-block" style=" font-family:Helvetica; float: left; width:50%;">
            <h3 style=" font-family:Helvetica; margin:5px 0px; font-size:14px; line-height: 17px; color: #000; text-transform: uppercase; ">WHAT IS A PluMBINg CERTIfICATE Of COMPlIANCE (COC)?</h3>
            <p style=" font-family:Helvetica; font-size: 14px; line-height: 17px; padding: 0; margin: 2px 0; color: #000; font-weight: 400;"> A  Plumbing  COC  is  a  means  by  which  the  Plumbing  Industry  Registration  Board  (PIRB) 
              ...
              <h3 style=" font-family:Helvetica; margin:1px 0px; font-size:16px; line-height: 17px; color: #000; text-transform: uppercase; ">JOBS wHICH REqUIRE A COC</h3>
        ...
        <div class="rt-block" style=" font-family:Helvetica; float: right; width: 49%;">
            ...
            <h3 style=" font-family:Helvetica; margin:8px 0px; font-size:16px; line-height: 16px; color: #000; text-transform: uppercase; margin:2px 0; ">DISPOSAL OF COMPLIANCE CERTIFICATES</h3>
            <p style=" font-family:Helvetica; font-size: 14px; line-height: 16px; padding: 0; margin: 9px 0; color: #000; font-weight: 400;">If for any reason, a licensed person does not intend to use a compliance certificate for its 
            ...
            declaration. </p>
            <h3 style=" font-family:Helvetica; margin:8px 0px; font-size:16px; line-height: 16px; color: #000; text-transform: uppercase; margin:3px 0; ">THE PURPOSE OF AN AUDIT</h3>
            ...
            <h3 style=" font-family:Helvetica; margin:9px 0px; font-size:16px; line-height: 16px; color: #000; text-transform: uppercase; ">AUDIT PROCESS</h3>
            <p style=" font-family:Helvetica; font-size: 14px; line-height: 16px; padding: 0; margin: 9px 0; color: #000; font-weight: 400;">A computer random selection of COC for which a compliance certificate has be lodged with 
            ...
            <h3 style=" font-family:Helvetica; margin:9px 0px; font-size:16px; line-height: 19px; color: #000; text-transform: uppercase; ">wHAT HAPPENS IF MY wORK DOES NOT PASS AN AUDIT?</h3>
            <p style=" font-family:Helvetica; font-size: 14px; line-height: 16px; padding: 0; margin: 9px 0; color: #000; font-weight: 400;">If the audited work is found not to comply, you will be advised of the work requiring attention in 
            ...
            <h3 style=" font-family:Helvetica; margin:9px 0px; font-size:15px; line-height: 17px; color: #000; text-transform: uppercase; margin-top: 3px; ">IF YOU DISAgREE wITH AN AUDIT RESULT</h3>
        ...
        <div class="type" style=" font-family:Helvetica; border: 1px solid #939598; width: 100%; font-size: 14px; line-height: 16px; font-weight: 400;">
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; float: left; width:92%; background: #d1e28d;  box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            <div class="lt-left" style=" font-family:Helvetica; float: left; width: 6%; text-align: center; border-right: 1px solid #939598; padding:18px 4px; box-sizing: border-box; ">
              <h3 style=" font-family:Helvetica; margin:12px 0px; font-size: 22px; line-height: 17px; font-weight: 600; color: #d2232a;">01</h3>
            </div>
            <div class="rt-right" style=" font-family:Helvetica; float: left; width:92%; background: #fbf0eb; padding:4px; box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #eff9fe; padding: 4px 4px 4px 4px; box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #f0eff7; padding: 4px 4px 4px 4px; box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            <div class="lt-left" style=" font-family:Helvetica; box-sizing: border-box; float: left; width: 6%; text-align: center; border-right: 1px solid #939598; padding:18px 4px;">
              <h3 style=" font-family:Helvetica; margin:12px 0px; font-size: 22px; line-height: 17px; font-weight: 600; color: #f36f21;">04</h3>
            </div>
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #fff5ed; padding: 4px 4px 4px 4px; box-sizing: border-box;">
              ...
              pressure regulating valve, which shall include but not be limited to: the pressure regulating valve; an electrical hot water cylinder; all relevant valves and components and all hot 
              water pipe and fittings, and shall end at any of the hot water terminal fittings;  but shall  exclude  any sanitary  fittings,  solar and heat pump installations. The scope of work and 
              non-compliance on pre-existing installations by others must be clearly noted in the installation details provided overleaf.)<span style=" font-family:Helvetica; color: #d2232a; font-weight: 600; font-size: 15px;">work can only be undertaken by a Licensed Plumber registered to do this specialised work.</span></p>
            </div>
            <div style=" font-family:Helvetica; clear:both;"></div>
          </div>
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #f3efeb; padding: 4px 4px 4px 4px; box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #f3f8f1; padding: 4px 4px 4px 4px; box-sizing: border-box;">
          ...
          <div class="block" style=" font-family:Helvetica; border-bottom: 1px solid #939598;">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #e7e9f1; padding: 4px 4px 4px 4px; box-sizing: border-box;">
          ...
          <div class="block">
            ...
            <div class="rt-right" style=" font-family:Helvetica; box-sizing: border-box; float: left; width:92%; background: #f5e9e3; padding: 4px 4px 4px 4px; box-sizing: border-box;">
