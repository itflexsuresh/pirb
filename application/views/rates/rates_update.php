 ...
 <div class="row">
    <div class="col-sm-12">
        <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="amountVAT" value="<?php echo $records[0]->Amount; ?>" placeholder="Enter an Amount" class="form-control" autocomplete="off" min="1" step="any" required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <!--/span-->
                        ...
                        <div class="radio-list">
                            <label class="radio-inline p-0">
                                <div class="radio radio-info">
                                    ...
                                    <label for="radio1">Current</label>
                                </div>
                            </label>
            ...
            <?php
            if($records[0]->futureammount && $records[0]->futuredate != ''){ 
                // $DBfuturedate = str_replace('-"', '/', $orgDate);  
                // $newDate = date("Y/m/d", strtotime($date));  
                $Futuredate = date("m/d/Y", strtotime($records[0]->futuredate));
                ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">                        
                        <!-- <h3 class="box-title m-b-0">Bordered Table</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Future Ammount</th>
                                            <th>Future Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><?php echo $records[0]->futureammount; ?></td>
