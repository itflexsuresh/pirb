                  ...
                  <tbody>
                    <tr>
                      ...
                      foreach ($records as $key) {
                        $date = date("Y/m/d", strtotime($key->ValidFrom));
                        ?>
                        <td><?php echo $key->SupplyItem; ?></td>
                        <td><?php echo $key->Amount; ?></td>
                        <td><?php echo $date; ?></td>
                        <td><a href='<?php echo base_url()."rates_test/update_view/".$key->ID; ?>' data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a></td>
