...
<head>
    ...
    <title>AuditIT | Plumber Update</title>
...
<body class="plumber_update">
        <div class="tittle">
            <div class="container logo">
                <h1>
                    <img src="<?= $base_path; ?>assets/images/PIRB_logo.png">
                </h1>
            </div>
        </div>
...
?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('.dropify').dropify();
            //  $('#IDPhoto').dropify({defaultFile: '../..//uploads/author5.png'});
