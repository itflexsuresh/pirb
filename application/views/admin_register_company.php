...
<?php } ?>
	...
	<table id="first-one" style="width: 20%">
		...
		<div class="col-md-12 form-group cmpny_sections complany_dtls">                                
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="user_edits">
                                        <input name="company_name" type="text" id="ContentPlaceHolder1_CompanyName" class="form-control" onkeypress="return AllowAlphabet(event)"  /><div id="message"><?php echo form_error('company_name'); ?></div></br>
                                    </div>
                                </div>
							...
							<div class="col-md-6 form-group" style="float: right;">
                                    ...
                                    <div class="user_edits">
                                        <input name="reg_number" type="text" id="ContentPlaceHolder1_CompanyRegNo" class="form-control" onkeypress="return AllowNumber(event)" /><div id="message"><?php echo form_error('reg_number'); ?></div></br>
                                    </div>
                                </div> 
		...
		<div class="col-md-6 form-group" style="clear: both;">
                                    ...
                                    <div class="user_edits">
                                        <input name="vat_number" type="text" id="ContentPlaceHolder1_VatNo" class="form-control" onkeypress="return AllowNumber(event)" /><div id="message"><?php echo form_error('vat_number'); ?></div></br>
                                    </div>
                                </div>
		...
		<div class="col-md-6 form-group required" style="clear: both;">
                                    ...
                                    <div class="user_edits">
                                        <input name="prim_person" type="text" id="ContentPlaceHolder1_CompanyContactPerson" class="form-control" onkeypress="return AllowAlphabet(event)" /><div id="message"><?php echo form_error('prim_person'); ?></div></br>
                                    </div>
                                </div>
 		...
 		<div class="col-md-12 form-group cmpny_sections txt_area_msg">
                                ...
                                <div class="col-md-6 form-group required">
                                    ...
                                    <div class="user_edits">
                                        <textarea name="com_message" rows="2" cols="20" id="ContentPlaceHolder1_txtCompMsg" class="form-control">
		...
		<div class="col-md-6 qualification_details cmpny_sections physcl_addrss" style="padding-left: 0px; padding-right: 0px">
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="user_edits">
                                        <input name="phy_address" type="text" id="ContentPlaceHolder1_CompanyPhysicalAddress" class="form-control" />
		...
		<div class="col-md-6 form-group  required">
                      <label>Physical Province</label>
                                    <div class="user_edits">
                                        <select name="province" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$DropDownList5\&#39;,\&#39;\&#39;   )&#39;, 0)" id="ContentPlaceHolder1_DropDownList5" class="form-control carets_icon">              
	...
	<option value="9">Western Cape</option>
		...
		<div class="col-md-6 form-group  required">
                                    ...
                                    <div class="user_edits">
                                        <div class="controls">
                                            <select name="city" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$physicalCities\&#39;,\&#39;\&#39;)&#39;, 0)" id="ContentPlaceHolder1_physicalCities" class="form-control  carets_icon">
	<option selected="selected" value=""></option>
 	...
 	<div class="col-md-6 form-group  required">
                                    ...
                                    <div class="user_edits">
                                        <div class="controls">
                                            <select name="suburb" id="ContentPlaceHolder1_physicalSuburb" class="form-control select2  carets_icon">
	<option value=""></option>
 ...
 -->                                        </div>
                              ...
                              <div class="col-md-6 qualification_details cmpny_sections pstl_addrss" style="padding-left: 0px; padding-right: 0px">
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="user_edits">
                                        <input name="post_address" type="text" id="ContentPlaceHolder1_CompanyPostalAddress" class="form-control" /><div id="message"><?php echo form_error('post_address'); ?></div></br>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="user_edits">
                                        <div class="controls">
                                            <select name="province_state" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$DropDownList4\&#39;,\&#39;\&#39;)&#39;, 0)" id="ContentPlaceHolder1_DropDownList4" class="form-control carets_icon">
	...
	<option value=""></option>
		...
		<div class="col-md-6 form-group" style="clear: both;">
                            ...
                            <div class="col-md-12 qualification_details cmpny_sections cntct_dtls" style="padding-left: 0px; padding-right: 0px">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="user_edits">
                                        <input name="work_phone" type="text" maxlength="10" id="ContentPlaceHolder1_CompanyWorkPhone" class="form-control" onkeypress="return AllowNumber(event)" /><div id="message"><?php echo form_error('work_phone'); ?></div></br>
                                    </div>
                                </div>
		...
		<div class="col-md-6 form-group" style="clear: both;">
                                    ...
                                    <div class="user_edits">
                                        <input name="mobile_phone" type="text" maxlength="10" id="ContentPlaceHolder1_CompanyMobilePhone" class="form-control"  onkeypress="return AllowNumber(event)" /><div id="message"><?php echo form_error('mobile_phone'); ?></div></br>
                                    </div>
		...
		<div class="col-md-6 form-group  required" style="clear: both;">
                                    ...
                                    <div class="user_edits">
                                        <input name="email" type="email" id="ContentPlaceHolder1_CompanyEmailAddress" class="form-control"  /><div id="message"><?php echo form_error('email'); ?></div></br>
                                    </div>
