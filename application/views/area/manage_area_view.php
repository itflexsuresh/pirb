    ...
    <div class="white-box">
           <!--  <h3 class="box-title m-b-0">Form Validation</h3>
            ...
            <!-- <form data-toggle="validator"> -->
              <?php
              echo form_open_multipart('manage_area/insert_records', $attributes_installationType);
              ?>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="managesuburb" type="text" id="ContentPlaceHolder1_managesuburb" class="form-control" placeholder="Suburb" value="<?php if($this->session->flashdata('suburb_validate')!==''){ echo $this->session->flashdata('suburb_validate'); } ?>">
                      </div>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div>
                <?php  } elseif($this->session->flashdata('radio_flash')=='Newcity'){ ?>
                  <div class="row">
                    <div class="col-md-6">
                      <div  class="form-group">
                        <label>City</label>
                    ...
                    //if($key->is_active==1){   
                        ...
                        <?php if ($key->isActive==1) { ?>
                          <tr>
                            ...
                            <td id="ones"><div class="col-sm-6 col-md-4 col-lg-3"><a href='<?php echo base_url()."Manage_area/addToArchive/".$key->SuburbID; ?>' data-toggle="tooltip" data-original-title="Add To Archive" onclick="return confirm('You Want Move This To Archive ?');" ><i class="fa fa-check-circle"></i></a></div> <a href='<?php echo base_url()."Manage_area/update/".$key->SuburbID; ?>' data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a></td>
                    ...
                    //if($sel_data1->is_active==1){   
                        ...
                        <?php if ($sel_data1->isActive==0) { ?>
                          <tr>
                            ...
                            <td id="zeros"><div class="col-sm-6 col-md-4 col-lg-3"><a href='<?php echo base_url()."Manage_area/addToActive/".$sel_data1->SuburbID; ?>' data-toggle="tooltip" data-original-title="Add To Active" onclick="return confirm('You Want Move This To Active ?');"><i class="fa fa-check-circle"></i></a></div> <a href='<?php echo base_url()."Manage_area/update/".$sel_data1->SuburbID; ?>' data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> <a href='<?php echo base_url()."Manage_area/deleteArea/".$sel_data1->SuburbID; ?>' data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close text-danger" onclick="return confirm('You Want Delete This ?');"></i> </a></td>
