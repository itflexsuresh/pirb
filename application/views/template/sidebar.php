			...
			<ul id="sidebarnav">
				<?php if($type=='1'){ ?>
					...
					<li> 
						...
						<li> 
							<a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Performance Settings</span></a>
							<ul aria-expanded="false" class="collapse">
