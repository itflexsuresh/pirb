    ...
    public function DTDocuments()
    {
        ...
        if(count($results) > 0){
            foreach($results as $result){
               ...
               // print_r(strtotime($result['updated_at']));die;
                if (strtotime($result['updated_at'])!='0' || strtotime($result['updated_at'])!=0 || strtotime($result['updated_at'])!=-62170003270 || strtotime($result['updated_at'])!='-62170003270') {
