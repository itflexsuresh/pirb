...
class Coc_Orders extends CC_Controller 
{
	...
	public function index()
	{
		...
		$data['content'] 			= 	$this->load->view('admin/cocmanagement/cocmanagetstatement/coc_order_index', (isset($pagedata) ? $pagedata : ''), true);
			...
			foreach($results as $result){
				$totalrecord[] = 	[
										...
										'action'	=> 	'<div class="table-action">
																<a href="'.base_url().'admin/cocmanagement/cocmanagetstatement/coc_order_index/'.$result['id'].'" data-toggle="tooltip" data-placement="top" title="Edit">
