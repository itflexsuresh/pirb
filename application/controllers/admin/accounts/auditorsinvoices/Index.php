	...
	public function generatepdf($inv_id)
	{
		...
		if ($rowData['coc_type'] == '1') {
			...
			if($rowData["status"]=='1'){
				...
				$paid ='<img tyle="width: 290px;" src="'.$this->base64conversion(base_url()."assets/images/unpaid.png").'">';
				$paid_status = "UNPAID";
			...
			$html = '<!DOCTYPE html>
					...
					<td>
						<img class="paid" style="width: 250px;" src="'.$this->base64conversion(base_url()."assets/images/paid.png").'">
					</td>
					</tr>
