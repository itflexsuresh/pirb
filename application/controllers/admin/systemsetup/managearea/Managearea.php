	...
	public function index($id='')
	{
		if($id!=''){
			...
			if($result){
				...
				redirect('admin/systemsetup/managearea'); 
			}
		}
		...
		$data['content'] 			= $this->load->view('admin/systemsetup/managearea/index', (isset($pagedata) ? $pagedata : ''), true);
		$this->layout2($data);
	}
				...
				$totalrecord[] = 	[
										...
										'action'	=> 	'
															<div class="table-action">
																<a href="'.base_url().'admin/systemsetup/managearea/index/'.$result['id'].'" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-alt"></i></a>
